      ...
      <div className="py-20 bg-chHero">
        <div className="container mx-auto px-6 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <div className="text-5xl md:text-7xl font-accent font-bold text-secondary leading-none mb-2">04</div>
      ...
      <div className="bg-white py-16 lg:py-24">
        <div className="container mx-auto px-6 max-w-4xl space-y-20">
          ...
          <section>
            ...
            <p className="text-lg md:text-xl font-bold text-secondary uppercase tracking-wide mb-6">Corporate Social Responsibility</p>
            ...
            <p className="text-black text-lg md:text-xl leading-relaxed mb-1 underline font-bold">Figure: 8</p>
            ...
            <p className="text-base md:text-lg leading-relaxed text-gray-900 mb-10">
            ...
            <p className="text-base md:text-lg leading-relaxed text-black mb-12">
            ...
            <p className="text-lg md:text-xl font-bold text-secondary uppercase tracking-wide mb-6">Family and Individual Philanthropy</p>
            ...
            <p className="text-lg md:text-xl font-bold text-secondary uppercase tracking-wide mb-6">International Funders</p>
            ...
            {/* THE STATE */}
            <p className="text-lg md:text-xl font-bold text-secondary uppercase tracking-wide mb-6">The State</p>
            ...
            <p className="text-lg md:text-xl font-bold text-black mb-1 underline">Figure: 9</p>
            ...
            {/* THE VISIBLE CORE */}
            <p className="text-lg md:text-xl font-bold text-secondary uppercase tracking-wide mb-6">The Visible Core: Work That Is Easy to Fund</p>
            ...
            {/* THE THINNER EDGE */}
            <p className="text-lg md:text-xl font-bold text-secondary uppercase tracking-wide mb-6">The Thinner Edge: Work That Is Still Underfunded</p>
            ...
            <p className="text-lg md:text-xl font-bold text-secondary uppercase tracking-wide mb-6">The Connective Layer: Functions That Sustain the Ecosystem</p>
          ...
          <section>
            ...
            <p className="text-black text-lg md:text-xl leading-relaxed mb-1 underline font-bold">Table 8</p>
            <p className="text-black text-lg md:text-xl leading-relaxed mb-6 font-bold">Capacity needs of nonprofits across two time horizons, n=109</p>
            ...
            <p className="text-base md:text-lg leading-relaxed text-black mb-6">Several things are worth holding together from these results.</p>
            <ol className="list-decimal list-inside space-y-4 mb-10 text-base md:text-lg text-black leading-relaxed marker:text-secondary marker:font-bold">
            ...
            <p className="text-base md:text-lg leading-relaxed text-black mb-6">Four structural conditions cannot be sustained under the current approach:</p>
