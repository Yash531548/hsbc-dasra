      ...
      <div className="bg-white py-16 lg:py-24">
        <div className="container mx-auto px-6 max-w-4xl space-y-20">
          ...
          <section>
            ...
            <p className="text-lg leading-relaxed text-gray-700 mb-6">Several things are worth holding together from these results.</p>
            ...
            <p className="text-lg leading-relaxed text-gray-700 mb-6">Four structural conditions cannot be sustained under the current approach:</p>
