      ...
      <div className="py-20 bg-chHero" >
        <div className="container mx-auto px-6 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <div className="text-5xl md:text-7xl font-accent  text-secondary leading-none mb-2">Executive Summary</div>
          </motion.div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <div className="p-8 bg-box rounded-xl mb-12">
              <p className="text-xl md:text-2xl font-heading font-medium text-black">
                Yet, for an estimated <br /><span className="font-extrabold text-2xl md:text-3xl">40–90 million </span><br /> persons with disabilities, the distance between legal recognition and lived reality remains wide.
              </p>
            </div>

            <p className="text-base md:text-lg text-black leading-relaxed mb-10">Across education, employment, healthcare, public infrastructure, and civic life, access
            ...
            <p className="text-base md:text-lg text-black leading-relaxed mb-10">This report draws on secondary research, 23 semi-structured interviews, two focus group
            ...
            <div className="space-y-16">
              {/* one */}
              <section>
                <h2 className="text-xl md:text-2xl font-heading font-bold text-chHeading mb-4 flex items-center gap-3">
                ...
                <p className="text-gray-900 mb-4 text-base md:text-lg">Disability exclusion is not simply a failure of implementation. It is produced by how
                ...
                <h3 className="text-secondary text-lg md:text-xl font-heading font-bold mb-6">THREE DYNAMICS SHAPE HOW THIS EXCLUSION OPERATES:</h3>
                ...
                <p className="leading-relaxed text-base md:text-lg">The result is a persistent misalignment: rights exist, but systems remain underprepared to deliver them.</p>
              </section>
              {/* Two */}
              <section>
                <h2 className="text-xl md:text-2xl font-heading font-bold text-chHeading mb-4 flex items-center gap-3">
                ...
                <p className="text-gray-900 mb-4 text-base md:text-lg">The nonprofit sector occupies a structurally unusual position in the disability ecosystem.
                ...
                <h3 className="text-secondary text-lg md:text-xl font-heading font-bold mb-6">DATA FROM 109 DISABILITY-FOCUSED NONPROFITS REVEALS A SECTOR THAT
              ...
              <section>
                ...
                <p className="text-gray-900 mb-4 text-base md:text-lg">Disability exclusion is not confined to any one domain. It cuts across education,
                ...
                <p className="text-gray-900 mb-4 text-base md:text-lg">These pathways are shaped at multiple levels: visible events, recurring patterns,
                ...
                <p className="text-gray-900 mb-4 text-base md:text-lg">Nonprofit efforts are concentrated in more fundable domains: education (63%), livelihoods
                ...
                <p className="text-gray-900 mb-4 text-base md:text-lg font-bold">This is the central finding for funders and policymakers: the work most difficult to fund
                  is often the work most necessary for durable change. </p>
                <p className="text-gray-900 mb-4 text-base md:text-lg">Service delivery may respond to visible exclusion, but shifts in systems, accountability,
              ...
              <section>
                ...
                <p className="text-gray-900 mb-4 text-base md:text-lg">India’s social sector spending has expanded to approximately INR 27 lakh crore, yet a
                ...
                <p className="text-gray-900 mb-4 text-base md:text-lg">CSR spending on disability-linked categories accounts for just 1% of total CSR expenditure,
                ...
                <p className="text-gray-900 mb-4 text-base md:text-lg">The structure of funding shapes what the ecosystem can sustain. Work that fits within
                  clear mandates is easier to fund than work that requires coordination, long-term
                  investment, or system-level change.</p>
                <p className="font-bold text-gray-900 mb-4 text-base md:text-lg">Organizations report consistent capacity gaps:</p>
                <img src="/executive/fourthBar.png" alt="" className="w-full object-contain" />
                <p className="text-gray-900 mb-4 text-base md:text-lg font-bold">The current funding architecture shows underinvestment in core, connective, and
              ...
              <section>
                ...
                <p className="text-gray-900 mb-6 text-base md:text-lg">The report closes by identifying five cornerstones that can help move disability inclusion
                ...
                <p className="text-base md:text-lg mb-6 text-gray-900">The three horizons framework helps locate these efforts across time: from access to
                ...
                <p className="text-base md:text-lg text-gray-900 mb-6">This further reframes the recommendations as a map of responsibility over time, not only
                  what must change, but where change can be anchored so inclusion no longer depends on
                  negotiation each time.</p>
                <p className="text-base md:text-lg text-gray-900 mb-6 font-bold">Disability exclusion is produced by systems built around a narrow idea of whose bodies,
