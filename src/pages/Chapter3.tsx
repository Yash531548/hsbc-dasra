    ...
    <Layout>
      <div className="py-20 bg-chHero">
        <div className="container mx-auto px-6 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <div className="text-5xl md:text-7xl font-accent font-bold text-secondary leading-none mb-2">03</div>
      ...
      <div className="bg-white py-16 lg:py-24">
        <div className="container mx-auto px-6 max-w-4xl space-y-20">
          ...
          {/* Intro */}
          <section>
            <p className="text-base md:text-lg leading-relaxed text-black mb-10">
          ...
          <section>
            ...
            <blockquote className="pl-6 mb-10">
              <p className="text-base md:text-lg leading-relaxed text-black italic mb-2">
            ...
            <p className="text-black text-lg md:text-xl leading-relaxed mb-1 font-bold">Figure 6:</p>
            ...
            <p className="text-lg md:text-xl font-bold text-secondary uppercase tracking-wide mb-6">Breakpoints:</p>

            {/* School dropouts */}
            <p className="text-lg md:text-xl font-bold text-gray-900 mb-4 flex gap-2 items-start">
              <Astroid className="w-4 h-4 text-astroid shrink-0 mt-2" fill="#9196CD" />
              School dropouts and unequal learning outcomes
            </p>
            <p className="text-base md:text-lg leading-relaxed text-black mb-8">
              Despite clear legal mandates, access to mainstream education for children with disabilities remains a persistent challenge. Inaccessible infrastructure, an absence of reasonable accommodations, and a lack of accountability towards inclusive classroom practice are well-documented across studies and government audits. A 2019 study estimated that more than 28% of children with disabilities aged between 6 and 13 years were not attending school, a number that rose to almost 44% when it came to children with multiple disabilities.Gaps in physical infrastructure remain equally stark. Per recent data, only 35.6% of schools in India reported the availability of accessible toilets on their premises.
            </p>
            ...
            <p className="text-base md:text-lg leading-relaxed text-black mb-8">
              The economic cost of excluding disabled people from the workforce is not incidental. Global data estimates that it can cost low- and middle-income countries up to 7% of GDP. In India, recent estimates placed labor force participation among persons with disabilities aged 15 and above around a mere 23.8%.Academician-activist Dr. Nandini Ghosh notes that a substantial number of people with disabilities in India are often <em className="text-secondary font-medium">"confined to home-based industries"</em>, excluded from meaningful workforce participation. People with disabilities make up less than 1% of the country's corporate workforce, and those who do make it in are often confined to entry-level or blue-collar positions irrespective of their qualifications.
            </p>
            ...
            <p className="text-base md:text-lg leading-relaxed text-black mb-8">
              The gap between the RPwD Act's mandate and its reach into everyday governance is measurable and wide. In 2018, only 42% of states had notified their State Rules, despite a six-month statutory deadline spelt out under the Act. While state engagement has improved since, policy coverage and implementation at the last mile continues to lag behind. Recent estimates suggest that less than 40% of India's estimated disabled population has been issued a UDID, envisioned as a gateway document for most central government schemes and entitlements.
            </p>
            ...
            <p className="text-base md:text-lg leading-relaxed text-black mb-8">
              Barriers faced by students with disabilities are concentrated at critical transition points. Pan-India school enrolment for children with disabilities peaked at almost 44% at the primary level, declining to less than one-fifth (around 7%) in secondary education, and further to a mere 5% in higher education. Reflecting on exclusion in the education-to-employment pipeline, Shamin Mehrotra from Ummeed Child Development Center shared, <em className="text-secondary font-medium">"These are the 'missing years', where young disabled adults entering the world can't find meaningful employment."</em> These barriers are reinforced by inadequate educator training and a lack of inclusive curricula. Richa Bhutani from Tata Institute of Social Sciences, highlighted that special educators are often trained in only one type of disability, <em className="text-secondary font-medium">"but classroom realities are different."</em>
            </p>
            ...
            <p className="text-base md:text-lg leading-relaxed text-black mb-8">
              The economic consequences of disability often compound upon entry into the workforce. A pan-India study indicated that workers with disabilities may earn between 1% to 24% lesser annually. It also highlighted that households with one disabled person spent around 12% more annually, while those with multiple disabled members spent up to 16% more. Lower earnings stretched across higher cost burdens produce multidimensional poverty, a pattern replicated by the labor market. Socioeconomic dimensions like gender sharpen this further: only 23% of women with disabilities were estimated to be in the workforce, as compared to 47% of men. Shilpi Kapoor from BarrierBreak added that traditional skilling initiatives can sometimes cast disabled people as <em className="text-secondary font-medium">"perpetual learners"</em>, deprioritizing workforce mobility.
            </p>
            ...
            <p className="text-base md:text-lg leading-relaxed text-black mb-8">
              Global research notes that health solutions for disabled people focus on episodic treatment and acute conditions, overlooking the continuing and coordinated care often required by people with long-term disabilities. In India, despite being the first point of contact for most people with disabilities, healthcare facilities and services are seldom equipped to provide disability-inclusive primary care. The absence of coordinated institutional accountability translates directly into coverage failures on the ground. A recent study found that more than 80% of people with disabilities had no health insurance, further exacerbating inaccessibility. Mental health is another key concern — almost 60% people with common mental disorders in India reported living with a disability, but the treatment gap remained high at 80%.
            </p>
            ...
            <p className="text-base md:text-lg leading-relaxed text-black mb-8">
              Across built, digital, and even emergency and climate infrastructure, a non-disabled person is typically the assumed user at the point of design. <em className="text-secondary font-medium">"To date, most states haven't updated their building by-laws in line with the RPwD Act,"</em> added Nipun Malhotra from The Quantum Hub. A digital audit found that three out of four government websites were inaccessible for disabled users. This ableist design logic extends beyond inaccessible physical and digital spaces, into how climate emergency and disaster response systems are configured and whom they exclude. A study in flood-prone Assam revealed that people with disabilities experienced two to four times higher disaster mortality due to inaccessible evacuation infrastructure, early warning systems, and emergency registers. Similarly, disabled people faced disproportionately high morbidity and mortality in climate disasters, caused by heat illness, water-related disease, and disruptions in access to medication and treatment.
            </p>
            ...
            <p className="text-base md:text-lg leading-relaxed text-black mb-8">
              Differential treatment often begins at home for disabled women in India. <em className="text-secondary font-medium">"Sometimes parents don't want to disclose a girl child's disability, fearing that it will affect her chances of getting married in the future,"</em> observed Beverly Louis from Mann. Research showed that disabled women and girls were up to ten times more likely to face violence — most often at the hands of caregivers, making it more difficult to report. Caste dimensions are often even more underexplored in the mainstream. Dr. O.P. Kulhari from CULP - Centre for Unfolding Learning Potentials noted, <em className="text-secondary font-medium">"The 2011 Census records 2.2% children with disabilities, but a household survey in a tribal area reported 8%. Some disabled children can't even reach hospitals to ensure they're counted."</em> Research indicates that Dalit girls with disabilities are likely to be married off to older men, producing higher rates of widowhood and deepening precarity. When marginalized identities converge, exclusion compounds in traceable rather than merely additive ways.
            </p>
            ...
            <p className="text-base md:text-lg leading-relaxed text-black mb-10">
              A system's knowledge about disability is shaped by the questions it chooses to ask. The UDID database, for instance, records age, gender, disability type, and percentage — but not caste, income, or education. While the 2011 Census estimates disability prevalence in India at 2.2%, this figure predates the RPwD Act's expanded 21-category definition and falls far below WHO estimates of 10–16%.Certification architecture also does not account for invisible and fluctuating manifestations, excluding certain forms of chronic illness and psychosocial disability entirely. Even as new disabilities are recognized by systems, protections often lag or remain inadequate in scope. Acid attack survivors, who are legally classified under locomotor disability, lack support for their psychosocial and reconstructive needs. A compensation framework based on employment fitness was used to track multigenerational health conditions among Bhopal gas tragedy survivors, leading to women and children automatically being categorized as minor injury cases.
            </p>
            ...
            <p className="text-base md:text-lg leading-relaxed text-black mb-8">
              Charity-based orientations have traditionally underpinned how government, industry, and philanthropy have tended to frame disability inclusion. These orientations position access, opportunity, and visibility in the mainstream as acts of extending goodwill, as opposed to conditions of belonging that disabled people hold claim to. Research with disability organizations in Hyderabad revealed that the charity frame came with an invisible demand: if people with disabilities did not come across as 'helpless', mainstream charitable support was less likely to notice their needs. The engagement thus produced is calibrated to an event or moment of mainstream visibility, veering away from the need for infrastructure that can sustain dignified, independent lives for disabled people. <em className="text-secondary font-medium">"Disability continues to be portrayed as 'bechara' — pitiable. That prevents the sector from moving beyond charity,"</em> shared Shilpi Kapoor from BarrierBreak.
            </p>
          ...
          <section>
            ...
            <p className="text-black text-lg md:text-xl leading-relaxed mb-1 font-bold underline">Figure 7:</p>
            ...
            <p className="text-lg md:text-xl font-bold text-secondary uppercase tracking-wide mb-6">Interventions:</p>

            <ul className="space-y-4 mb-10 text-base md:text-lg text-black leading-relaxed">
              {[
