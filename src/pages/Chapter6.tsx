    ...
    <Layout>
      <div className="py-20 bg-chHero">
        <div className="container mx-auto px-6 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <div className="text-5xl md:text-7xl font-accent font-bold text-secondary leading-none mb-2">06</div>
      ...
      <div className="bg-white py-16 lg:py-24">
        <div className="container mx-auto px-6 max-w-4xl space-y-20">
          ...
          <section>
            ...
            <div className="space-y-8 mb-10">
              {[
                ...
                <div key={i}>
                  <p className="text-black text-lg md:text-xl leading-relaxed mb-2 font-bold">{horizon.title}</p>
                  <p className="text-base md:text-lg leading-relaxed text-black">{horizon.text}</p>
                </div>
              ))}
            </div>
            ...
            <p className="text-black text-lg md:text-xl leading-relaxed mb-2 font-bold">Supporting this mandate is not only a strategic imperative for the sector, but a necessary condition for achieving equitable and inclusive development at scale.</p>
            <p className="text-black text-base md:text-lg leading-relaxed mb-10">
          ...
          {/* ANNEXURES */}
          <section>
            <h2 className="text-3xl md:text-4xl font-accent font-bold text-secondary uppercase tracking-wide mb-10">Annexures</h2>

            <h3 className="text-xl md:text-2xl font-heading font-bold text-subHeading mb-8">Methodology Note</h3>
          ...
          {/* ACKNOWLEDGEMENTS */}
          <section>
            <h3 className="text-2xl md:text-3xl font-heading font-bold text-subHeading mb-8">Acknowledgements</h3>
          ...
          <section>
            <h3 className="text-xl md:text-2xl font-heading font-bold text-chHeading mb-8">List of Sector Experts and Practitioners (A-Z)</h3>
          ...
          <section>
            <h3 className="text-xl md:text-2xl font-heading font-bold text-chHeading mb-8">List of Survey Respondents (A-Z)</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-2">
          ...
          {/* REFERENCES */}
          <section>
            <h2 className="text-3xl md:text-4xl font-accent font-bold text-secondary uppercase tracking-wide mb-10">References</h2>
