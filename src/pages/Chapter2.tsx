      ...
      <div className="py-20 bg-chHero">
        <div className="container mx-auto px-6 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <div className="text-7xl font-accent font-bold text-secondary leading-none mb-2">02</div>
      ...
      <div className="bg-white py-16 lg:py-24">
        <div className="container mx-auto px-6 max-w-4xl space-y-20">
          ...
          <section>
            ...
            <p className="text-black leading-relaxed mb-12 text-xl">
          ...
          <section>
            ...
            <p className="text-black text-lg leading-relaxed mb-10">Organizations operating at a greater distance from
