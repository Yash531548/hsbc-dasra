      ...
      <div className="py-20 bg-chHero">
        <div className="container mx-auto px-6 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <div className="text-5xl md:text-7xl font-accent font-bold text-secondary leading-none mb-2">02</div>
      ...
      <div className="bg-white py-16 lg:py-24">
        <div className="container mx-auto px-6 max-w-4xl space-y-20">
            ...
            <div>
              ...
              <div className="p-8 bg-box rounded-xl mb-8">
                <p className="text-xl md:text-2xl font-heading font-regular text-black">
                  <span className="font-bold text-2xl md:text-3xl">82% of responding</span><br />
                  organizations had been operational for more than ten years. The remaining 18% reported five to ten years of operation.
                </p>
              </div>

              <p className="text-black text-lg md:text-xl leading-relaxed mb-1 underline font-bold">Table 1:</p>
              <p className="text-black text-lg md:text-xl leading-relaxed mb-6 font-bold">Nonprofits by year of operation, n=109</p>
              ...
              <p className="text-black text-lg md:text-xl leading-relaxed mb-1 underline font-bold">Figure 1:</p>
              <p className="text-black text-lg md:text-xl leading-relaxed mb-6 font-bold">Nonprofits working in Disability Inclusion by Budget Size</p>
              ...
              <p className="text-black text-lg md:text-xl leading-relaxed mb-1 underline font-bold">Table 2</p>
              <p className="text-black text-lg md:text-xl leading-relaxed mb-6 font-bold">Nonprofits by annual budget size (FY 2025-26), n=109</p>
          ...
          <section>
            ...
            <p className="text-black text-lg md:text-xl leading-relaxed mb-1 underline font-bold">Table 3</p>
            <p className="text-black text-lg md:text-xl leading-relaxed mb-6 font-bold">Nonprofits by disability group focus, n=109</p>
            ...
            <p className="text-black text-lg md:text-xl leading-relaxed mb-1 underline font-bold">Table 4</p>
            <p className="text-black text-lg md:text-xl leading-relaxed mb-6 font-bold">Nonprofits by identity/population focus, n=109</p>
            <div className="overflow-x-auto border border-border mb-4">
              <table className="w-full text-xs md:text-sm border-collapse">
                <thead>
                  <tr className="bg-secondary text-white">
          ...
          <section>
            ...
            <div className="p-8 bg-box rounded-xl mb-10">
              <p className="text-xl md:text-2xl font-heading font-regular text-black">
                <span className="font-bold text-2xl md:text-3xl">Approximately 89% of</span><br />
            ...
            <p className="text-black text-lg md:text-xl leading-relaxed mb-1 underline font-bold">Table 5</p>
            <p className="text-black text-lg md:text-xl leading-relaxed mb-6 font-bold">Bottlenecks in nonprofit delivery, n=109</p>
            ...
            <p className="text-black text-lg md:text-xl leading-relaxed mb-1 underline font-bold">Table: 6</p>
            <p className="text-black text-lg md:text-xl leading-relaxed mb-6 font-bold">Constraints to collaboration for nonprofits, n=109</p>
            <div className="overflow-x-auto border border-border mb-10">
              <table className="w-full text-xs md:text-sm border-collapse">
                <thead>
                  <tr className="bg-secondary text-white">
            ...
            <p className="text-black text-lg md:text-xl leading-relaxed mb-1 underline font-bold">Table 7</p>
            <p className="text-black text-lg md:text-xl leading-relaxed mb-6 font-bold">Underfunded functions in nonprofits, n=109</p>
            <div className="overflow-x-auto border border-border mb-10">
              <table className="w-full text-xs md:text-sm border-collapse">
                <thead>
                  <tr className="bg-secondary text-white">
          ...
          <section>
            ...
            <p className="text-black text-xl italic leading-relaxed mb-2 pl-6 ">
            ...
            <p className="text-black text-base md:text-lg leading-relaxed mb-10">Organizations operating at a greater distance from
